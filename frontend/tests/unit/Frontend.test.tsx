...
describe("My Test Suite", () => {
  ...
  // Test 1: tests that elements are rendered properly in Submit New Article 
  ...
  // Test 6: tests form validation in Submit New Article with empty fields
  ...
  // Test 7: test to ensure input fields work in Submit New Article
